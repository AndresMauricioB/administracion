...
$("#btn_buscar_fecha").click(function() {
    ...
    $.get('http://127.0.0.1:8000/api/ventas?'+parametros_busqueda,function(response){
...
$.get('http://127.0.0.1:8000/api/nuevas-plataformas', function (response) {
...
$("#btn-env-add").click(function(e) {
    ...
    $.ajax({
        ...
        url: "http://127.0.0.1:8000/api/ventas/create",
        type: "POST",
        data: {
...
$('body').on('click', '.editVenta', function () {
      ...
      $.get('http://127.0.0.1:8000/api/ventas/details/'+id,function(response){
    ...
    $( "#btn-env-edit" ).click(function(e) {
        ...
        $.ajax({
            ...
            url: "http://127.0.0.1:8000/api/ventas/update/"+id,
            type: "POST",
            data: { 
                descripcion: descripcion,
                meses: meses,
...
$('#btn-env-delete').click(function(e){
    ...
    $.get('http://127.0.0.1:8000/api/ventas/details/'+id,function(response){
        ...
        $.ajax({
            ...
            url: "http://127.0.0.1:8000/api/ventas/delete/"+id,
            type: "POST",
...
function loadData() {
    ...
    $.get('http://127.0.0.1:8000/api/ventas?fechaEspecifica='+fechaFormateada,function(response){
