<script>
    ...
    $('body').on('click', '.editLogistica', function () {
        ...
        $.get('http://127.0.0.1:8000/api/logistica/details/'+id,function(response){
    ...
    $('#btn-env-delete').click(function(e){
        ...
        $.ajax({
            ...
            url: "http://127.0.0.1:8000/api/logistica/delete/"+id,
            type: "POST",
    ...
    $( "#btn-env-create" ).click(function(e) {
        ...
        $.ajax({
            ...
            url: "http://127.0.0.1:8000/api/logistica/create",
            type: "POST",
            data: {
                nombre:nombre,
    ...
    $( "#btn-env-avisos" ).click(function(e) {
        ...
        $.ajax({
            ...
            url: "http://127.0.0.1:8000/api/logistica/updateAdvice/"+id,
            type: "POST",
            data: {    
    ...
    $( "#btn-env-edit" ).click(function(e) {
        ...
        $.ajax({
            ...
            url: "http://127.0.0.1:8000/api/logistica/update/"+id,
            type: "POST",
            data: {    
                nombre:nombre,
                servicio_id:servicio_id,
    ...
    function loadData() {
        ...
        $.get('http://127.0.0.1:8000/api/logistica?'+filtros,function(response){
            ...
            function pross(item) {
                ...
                if(calcularDiasRestantes(item.fecha_vencimiento) <= -20 && item.decision == 0){
                    ...
                    $.post('http://127.0.0.1:8000/api/logistica/cambiarCorte/'+item.id,function(response){
                    });
