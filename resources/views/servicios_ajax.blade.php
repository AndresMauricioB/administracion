<script>
    ...
    $('body').on('click', '.editService', function () {
        ...
        $.get('http://127.0.0.1:8000/api/servicios/details/'+id,function(response){
    ...
    $('body').on('click', '.enableService', function () {
        ...
        $.post('http://127.0.0.1:8000/api/servicios/activar/'+id,function(response){
    ...
    $('#btn-env-delete').click(function(e){
        ...
        $.ajax({
            ...
            url: "http://127.0.0.1:8000/api/servicios/delete/"+id,
            type: "POST",
    ...
    $( "#btn-env-create" ).click(function(e) {
        ...
        $.ajax({
            ...
            url: "http://127.0.0.1:8000/api/servicios/create",
            type: "POST",
            data: {
    ...
    $( "#btn-env-edit" ).click(function(e) {
        ...
        $.ajax({
            ...
            url: "http://127.0.0.1:8000/api/servicios/update/"+id,
            type: "POST",
            data: {    
                descripcion:descripcion,
                responsable:responsable,
    ...
    function loadData() {
        ...
        $.get('http://127.0.0.1:8000/api/servicios',function(response){
